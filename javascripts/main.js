...
interval = setInterval(function() {
  ...
  output += `<p>Pear tree is now ${PearTree.height} tall and has ${PearTree.branches} branches </p>`;

// Pear tree is now 23cm tall and has 2 branches
// Oak tree is now 57cm tall and has 4 branches
  output += `<p>Oak tree is now ${OakTree.height} tall and has ${OakTree.branches} branches </p>`;
